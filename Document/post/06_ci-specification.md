...
본 문서는 `post` 서비스의 6개 백엔드 구현체에 공통으로 적용할 CI 기준을 정의한다.
...
- `.github/workflows/post-java-springboot-maven-postgresql-ci.yml`
- `.github/workflows/post-typescript-nestjs-npm-postgresql-ci.yml`
...
- `post-java-springboot-gradle-mysql-ci.yml`
- `post-typescript-nestjs-npm-postgresql-ci.yml`
- `post-typescript-nestjs-npm-mysql-ci.yml`
