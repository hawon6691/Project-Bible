package com.projectbible.post.maven.jpa.postgresql.comment.service;

import com.projectbible.post.maven.jpa.postgresql.comment.dto.CommentDtos.CommentResponseDto;
import com.projectbible.post.maven.jpa.postgresql.comment.dto.CommentDtos.CreateCommentDto;
import com.projectbible.post.maven.jpa.postgresql.comment.dto.CommentDtos.UpdateCommentDto;
import com.projectbible.post.maven.jpa.postgresql.comment.entity.CommentEntity;
import com.projectbible.post.maven.jpa.postgresql.comment.repository.CommentRepository;
import com.projectbible.post.maven.jpa.postgresql.common.api.MessageResponse;
import com.projectbible.post.maven.jpa.postgresql.common.api.PageMeta;
...
public class CommentService {
    ...
    public com.projectbible.post.maven.jpa.postgresql.admin.dto.AdminDtos.StatusResponseDto adminSetStatus(long commentId, String status) {
        CommentEntity comment = commentRepository.findDetail(commentId)
            .orElseThrow(() -> new AppException("COMMENT_NOT_FOUND", "Comment not found", HttpStatus.NOT_FOUND));
        ...
        commentRepository.save(comment);
        return new com.projectbible.post.maven.jpa.postgresql.admin.dto.AdminDtos.StatusResponseDto(comment.getId(), comment.getStatus(), comment.getUpdatedAt());
    }
