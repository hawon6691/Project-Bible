package com.projectbible.post.comment.service;
...
import com.projectbible.post.comment.dto.CommentDtos.CreateCommentDto;
import com.projectbible.post.comment.dto.CommentDtos.UpdateCommentDto;
import com.projectbible.post.comment.entity.CommentEntity;
import com.projectbible.post.comment.repository.CommentRepository;
import com.projectbible.post.common.api.MessageResponse;
import com.projectbible.post.common.api.PageMeta;
import com.projectbible.post.common.exception.AppException;
import com.projectbible.post.common.security.CurrentActor;
import com.projectbible.post.post.dto.PostDtos.AuthorDto;
...
public class CommentService {
    ...
    public com.projectbible.post.admin.dto.AdminDtos.StatusResponseDto adminSetStatus(long commentId, String status) {
        CommentEntity comment = commentRepository.findDetail(commentId)
            .orElseThrow(() -> new AppException("COMMENT_NOT_FOUND", "Comment not found", HttpStatus.NOT_FOUND));
        ...
        commentRepository.save(comment);
        return new com.projectbible.post.admin.dto.AdminDtos.StatusResponseDto(comment.getId(), comment.getStatus(), comment.getUpdatedAt());
    }
