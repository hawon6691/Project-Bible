package com.projectbible.post.auth.service;
...
import com.projectbible.post.auth.repository.AuthRepository;
import com.projectbible.post.common.exception.AppException;
import com.projectbible.post.common.security.CurrentActor;
import com.projectbible.post.common.security.TokenService;
...
public class AuthService {
    ...
    public com.projectbible.post.common.api.MessageResponse logout(CurrentActor actor) {
        if (!actor.isUser()) {
            throw new AppException("FORBIDDEN", "User access required", HttpStatus.FORBIDDEN);
        }
        authRepository.revokeAllUserTokens(actor.id());
        return new com.projectbible.post.common.api.MessageResponse("Logged out successfully");
    }
