package com.projectbible.shop.admin.service;

import com.projectbible.shop.admin.dto.AdminDtos.*;
import com.projectbible.shop.admin.entity.AdminEntity;
import com.projectbible.shop.admin.entity.AdminRefreshTokenEntity;
import com.projectbible.shop.admin.repository.AdminRepository;
...
import com.projectbible.shop.common.security.TokenService;
...
public class AdminService {
    ...
    private AdminLoginResponseDto issueTokens(AdminEntity admin) {
        ...
        return new AdminLoginResponseDto(accessToken, refreshToken, 1800, new AdminSummaryDto(admin.getId(), admin.getEmail(), admin.getName(), admin.getStatus(), admin.getCreatedAt()));
    }
